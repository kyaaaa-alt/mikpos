...
if(isset($_POST['kodemember'])){
    header('Location: ' . base_url('validity') . '/' . $userid . '/' . $routerid . '/' . $_POST['kodemember']);
    exit;
}
?>
    ...
    <main>
      <div class="container col-xl-10 col-xxl-8">
        <div class="row align-items-center g-lg-4 py-4">
          ...
          <h4 class="fw-bold text-center">Cek Status Member<br><?= $routername ?></h4>
            <form method="post" class="p-4 p-md-5 border rounded-3 bg-light">
              <small class="text-muted">Masukan kode member :</small>
              <hr class="my-4">
              <?php
              $session = session();
              ...
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="Kode Member" name="kodemember" required>
