    ...
    <div class="row">
        ...
        <div class="col-md-7 col-lg-12">
            <ul class="list-group mb-3">
                ...
                <?php if (str_contains($response->data->payment_name, 'QRIS') && ($response->data->status == 'UNPAID')) { ?>
                    ...
                    <h6 class="my-0">Kode QRIS</h6>
                        <div class="mt-1 w-100 d-flex justify-content-center">
                            <img src="<?= $response->data->qr_url ?>" width="75px" height="75px"/>
                        </div>
                    </div>
                </li>
                <?php } else { ?>
                <li class="list-group-item">
                    <div>
                    <h6 class="my-0">Kode Bayar (<?= $response->data->payment_name ?>)</h6>
                ...
                <li class="list-group-item d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        if ($response->data->status == 'UNPAID') {
                            echo '<small class="text-danger" style="font-size:12px;">Menunggu Pembayaran</small>';
